                ...
                <div class="panel" data-collapsed="0">
                    ...
                    <div class="panel-body">
                    	<div class="adv-table" style="overflow:scroll; overflow-x:auto; overflow-y:auto;">
                    		<table  class="display table table-bordered table-striped" style="max_width:1000px; max_height:500px;">
        						<thead>
  									<tr>
  		 						...
  		 						<tbody>
  									<c:forEach items="${applyList}"  var="apply">
     									...
     									<tr>
     										<input type="hidden" id="applyid" value="${apply.applyid}"/>
				  							...
				  							<td align=center style="vertical-align: middle;">
				  								<!-- <a href="${ctx}/apply/updateemployercheck?employercheck=1&applyid=${apply.applyid}"> -->
				  								<button class="btn btn-success" type="button" onClick="window.location.href='${ctx}/apply/updateemployercheck?employercheck=1&applyid=${apply.applyid}'">同意</button>
				  								
				  								
												<a href="${ctx}/apply/updateemployercheck?employercheck=2&applyid=${apply.applyid}">
												<button class="btn btn-warning" type="button">拒绝</button></a>
											</td>
				  						</tr>
				    				</c:forEach>
				    			</tbody>
                    ...
                    <div align="center">
               			<a href="${pageContext.request.contextPath}/apply/findEuncheck">首页</a>
               			<c:if test="${pageModel.pageNo>1}"><a href="${pageContext.request.contextPath}/apply/findEuncheck?pageNo=${pageModel.pageNo-1}">上一页</a></c:if>
               			<c:if test="${pageModel.pageNo<pageModel.totalpage}"><a href="${pageContext.request.contextPath}/apply/findEuncheck?pageNo=${pageModel.pageNo+1}">下一页</a></c:if>
               			<c:if test="${pageModel.totalpage!=0}"><a href="${pageContext.request.contextPath}/apply/findEuncheck?pageNo=${pageModel.totalpage}">尾页</a></c:if>

                ...
                <div class="panel" data-collapsed="0">
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                           	<strong>审核注册用户</strong>
                        </div>
                    </div>
                    <div class="panel-body">
                    	<div class="adv-table" style="overflow:scroll; overflow-x:auto; overflow-y:auto;">
                    		<table  class="display table table-bordered table-striped" style="width:800px;">
                    			<thead>
  									<tr>
  										<th align=center style="vertical-align: middle;">工号</th>
  										<th align=center style="vertical-align: middle;">姓名</th>
  										<th align=center style="vertical-align: middle;">职位</th>
		  								<th align=center style="vertical-align: middle;">邮箱</th>
		  								<th align=center style="vertical-align: middle;">审核</th>
  									</tr>
  		 						</thead>
  		 						<tbody>
  									<c:forEach items="${checklist}"  var="user">
     									<tr>
  											<td align=center style="vertical-align: middle;">${user.userid}</td>
  											<td align=center style="vertical-align: middle;">${user.username}</td>
				  							...
				  							<td align=center style="vertical-align: middle;">${user.email}</td>
				  							<td align=center style="vertical-align: middle;">
				  								<button class="btn btn-success" type="button" onClick="window.location.href='${ctx}/user/check?id=${user.userid}'">同意</button>
				  								
				  								
												<a href="${ctx}/user/checkdeny?id=${user.userid}">
													<button class="btn btn-warning" type="button">拒绝</button>
												</a>
											</td>
				  						</tr>
				    				</c:forEach>
                    ...
                    <div align="center">
               			<a href="${pageContext.request.contextPath}/user/checklist">首页</a>
               				<c:if test="${pageModel.pageNo>1}"><a href="${pageContext.request.contextPath}/user/checklist?pageNo=${pageModel.pageNo-1}">上一页</a></c:if>
               				<c:if test="${pageModel.pageNo<pageModel.totalpage}"><a href="${pageContext.request.contextPath}/user/checklist?pageNo=${pageModel.pageNo+1}">下一页</a></c:if>
               				<c:if test="${pageModel.totalpage!=0}"><a href="${pageContext.request.contextPath}/user/checklist?pageNo=${pageModel.totalpage}">尾页</a></c:if>

            ...
            <div class="col-md-12">
                ...
                <div class="panel" data-collapsed="0">
     									...
     									<tr>
				  							...
				  							<td align=center style="vertical-align: middle;">
				  								<c:choose>
				  									...
				  									<c:when test="${apply.employercheck==2}">
				  										<span class="label label-danger label-mini">未通过</span>
				  									</c:when>
				  									<c:when test="${apply.bosscheck==2}">
				  										<span class="label label-danger label-mini">未通过</span>	
   													</c:when> 
				  									<c:otherwise>
                    ...
                    <div align="center" style="vertical-align: middle;">
               			<a href="${pageContext.request.contextPath}/apply/findbyid">首页</a>
               			<c:if test="${pageModel.pageNo>1}"><a href="${pageContext.request.contextPath}/apply/findbyid?pageNo=${pageModel.pageNo-1}">上一页</a></c:if>
               			<c:if test="${pageModel.pageNo<pageModel.totalpage}"><a href="${pageContext.request.contextPath}/apply/findbyid?pageNo=${pageModel.pageNo+1}">下一页</a></c:if>
               			<c:if test="${pageModel.totalpage!=0}"><a href="${pageContext.request.contextPath}/apply/findbyid?pageNo=${pageModel.totalpage}">尾页</a></c:if>

		 ...
		 $(function(){
            	  $("#btn3").click(function(){
            		  var apply={
            				  'start':$("#start").val(),
            				  'destiny':$("#destiny").val(),
            				  'tovehicle':$("#tovehicle").val(),
            				  'backvehicle':$("#backvehicle").val(),
            		  ...
            		  var re=/^[0-9]$/;
            		  if(apply.days==""||(isNaN(apply.days))||(!re.test(apply.days)))
            		  {
            				alert("出差天数输入错误");
            				return;
            		  }
            		  if(apply.meal==""||(isNaN(apply.meal))||apply.meal<=0)
            		  {
            				alert("日均伙食费输入错误");
            				return;
            		  }
            		  if(apply.budget==""||(isNaN(apply.budget))||apply.budget<=0)
            		  {
            				alert("个人总预算输入错误");
            				return;
            		  }
                      $.ajax({                           	  
                          ...
                          if (msg == "mdzz"){ 
                        	  alert("提交成功");
                        	  location.href = "${ctx}/apply/findbyid";
                          }    
                          else{
                        	  alert("输入错误！请重新输入");
                          }
            ...
            <div class="col-md-12">
                ...
                <div class="panel" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">出发地：
                                <select type="text" id="start" name="start" class="form-control input-lg m-bot15" placeholder="出发地">
                            ...
                            <div class="col-md-6 form-group">目的地：
                                <select type="text" id="destiny" name="destiny" class="form-control input-lg m-bot15" placeholder="目的地">
										<c:forEach items="${cityList}"  var="City"> 
										<option value="${City.cityname}">${City.cityname}</option>
										</c:forEach>
								</select>
                            ...
                            <div class="col-md-4 form-group">起始日期：
                                <input id="startdate" class="form-control input-lg m-bot15" type="text" placeholder="起始日期" onfocus="WdatePicker({minDate:'%y-%M-{%d+1}'})"/>
                            </div>
			
							<div class="col-md-4 form-group">出发交通工具：
                                <select type="text" id="tovehicle" name="tovehicle" class="form-control input-lg m-bot15" placeholder="出发工具">
                            ...
                            <div class="col-md-4 form-group">返程交通工具：
                                <select type="text" id="backvehicle" name="backvehicle" class="form-control input-lg m-bot15" placeholder="返程工具">
										<c:forEach items="${vehicleList}"  var="vehicle"> 
										<option value="${vehicle.vehiclename}">${vehicle.vehiclename}</option>
										</c:forEach>
								</select>
                            ...
                            <div class="col-md-3 form-group">出差天数：
                                <input type="text" id="days" name="days" class="form-control input-lg m-bot15" placeholder="出差天数">
                            </div>

                            <div class="col-md-3 form-group">日均伙食费：
                                <input type="text" id="meal" name="meal" class="form-control input-lg m-bot15" placeholder="日均伙食费">
                            </div>

                            <div class="col-md-3 form-group">宾馆：
                                <select id="hotel" name="hotel" class="form-control input-lg m-bot15" placeholder="宾馆">
									<option value="0">不住宾馆</option>
									<option value="1">一星级宾馆</option>
									<option value="2">二星级宾馆</option>
									<option value="3">三星级宾馆</option>
									<option value="4">四星级宾馆</option>
									<option value="5">五星级宾馆</option>
								</select>
                            </div>

                            <div class="col-md-3 form-group">个人总预算：
                                <input type="text" id="budget" name="budget" class="form-control input-lg m-bot15" placeholder="个人总预算">
                            </div>

                        </div>
						<div class=" ">
                             <p>
                                 <button id="btn3" class="btn btn-primary btn-lg" type="button">    提交             </button>
                             </p>
                         </div>
                    </div>
...
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-daterangepicker/moment.min.js"></script>
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-daterangepicker/daterangepicker.js"></script>
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
<script type="text/javascript" src="${ctx}/AdminEx/js/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>

<!--pickers initialization-->
<script src="${ctx}/AdminEx/js/pickers-init.js"></script>

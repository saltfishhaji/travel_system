		 ...
		 <div class="wrapper">
            ...
            <div class="col-md-12">
                ...
                <div class="panel" data-collapsed="0">
     									...
     									<tr>
     										<input type="hidden" id="applyid" value="${apply.applyid}"/>
				  							...
				  							<td align=center style="vertical-align: middle;">
				  								...
				  								<button class="btn btn-success" type="button" onClick="window.location.href='${ctx}/apply/updatebosscheck?bosscheck=1&applyid=${apply.applyid}'">同意</button>
				  								
				  								
												<a href="${ctx}/apply/updatebosscheck?bosscheck=2&applyid=${apply.applyid}">
                    ...
                    <div align="center">
               			<a href="${pageContext.request.contextPath}/apply/findBuncheck">首页</a>
               				<c:if test="${pageModel.pageNo>1}"><a href="${pageContext.request.contextPath}/apply/findBuncheck?pageNo=${pageModel.pageNo-1}">上一页</a></c:if>
               				<c:if test="${pageModel.pageNo<pageModel.totalpage}"><a href="${pageContext.request.contextPath}/apply/findBuncheck?pageNo=${pageModel.pageNo+1}">下一页</a></c:if>
               				<c:if test="${pageModel.totalpage!=0}"><a href="${pageContext.request.contextPath}/apply/findBuncheck?pageNo=${pageModel.totalpage}">尾页</a></c:if>
